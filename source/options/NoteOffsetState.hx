...
class NoteOffsetState extends MusicBeatState
{
	...
	function repositionCombo()
	{
		...
		combo.y += 60 + ClientPrefs.comboOffset[5];
		reloadTexts();
	}
	...
	function reloadTexts()
	{
		for (i in 0...dumbTexts.length)
		{
			switch(i)
			{
				...
				case 7: dumbTexts.members[i].text = 'UP DOWN LEFT RIGHT:';
				case 8: dumbTexts.members[i].text = 'Move Rating Offset';
				case 9: dumbTexts.members[i].text = 'W A S D:';
				case 10: dumbTexts.members[i].text = 'Move Numbers Offset';
				case 11: dumbTexts.members[i].text = 'I J K L:';
				case 12: dumbTexts.members[i].text = 'Move Combo Offset';
				case 13: dumbTexts.members[i].text = 'Hold Shift to Move by 10';
			}
		}
	}
